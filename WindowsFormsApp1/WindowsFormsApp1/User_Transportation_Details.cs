...
*/
        ...
        private void pictureBox2_Click(object sender, EventArgs e)
        {
            if (dataGridView1.SelectedRows.Count > 0)
            {
                ...
                {
                    User_Transportation_Details_Show vs = new User_Transportation_Details_Show(selectedId);
                    vs.Show();
                    this.Hide();
                }
                else
        ...
        private void User_Transportation_Details_Load(object sender, EventArgs e)
        {
